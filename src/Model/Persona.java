...
public class Persona {
    ...
    public Persona() {
     ...
     public Persona(String nombre, String apellidos) {
        ...
        this.direccion = new SimpleStringProperty("C/Gaspar Archent nº1 1ºA");
        this.ciudad = new SimpleStringProperty("Villena");
        this.codigoPostal = new SimpleIntegerProperty(03400);
        this.fechaDeNacimiento = new SimpleObjectProperty(LocalDate.of(1997, 8, 11));
